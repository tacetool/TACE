...
void loadConfig() {
  ...
  if (garbageCollectionThreshold != nullptr) {
    try {
      ...
      std::cerr << "SYMCC_GC_THRESHOLD=" << g_config.garbageCollectionThreshold << '\n';
