...
protected:
  ...
  void printDepForest(std::ostream& os=std::cerr);
  ...
  void resolveConcreteDep(ExprRef e, DependencySet* symdep);
  void resolveNodeDep(ExprRef e, const DependencySet &concrete, const DependencySet &symbolic);
